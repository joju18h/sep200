...
int main() {
    ...
    owner = dog2.GetOwner();
    if (owner) cout << dog2.GetName() << " belongs to " << owner->GetName() <<endl;
    owner = dog3.GetOwner();
    if (owner) cout << dog3.GetName() << " belongs to " << owner->GetName() <<endl;
    owner = dog4.GetOwner();
    if (owner) cout << dog4.GetName() << " belongs to " << owner->GetName() <<endl;
    owner = dog5.GetOwner();
    if (owner) cout << dog5.GetName() << " belongs to " << owner->GetName() <<endl;
    owner = dog6.GetOwner();
    if (owner) cout << dog6.GetName() << " belongs to " << owner->GetName() <<endl;
